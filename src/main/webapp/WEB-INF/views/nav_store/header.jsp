							...
							<div class="layout-navigation-search" id="id-13">
								...
								<div class="layout-navigation-search__header">
									...
									<div id="id-13-combobox"
										...
										aria-haspopup="listbox" aria-expanded="false"></div>
...
<path d="M1 2h3v3"></path>
							...
							<div class="drop-down layout-navigation-bar-upload-button">
								...
								<button
									class="layout-navigation-bar-upload-button__button writeBtn1"
									type="button">
									글쓰기
...
<path fill="currentColor" fill-rule="evenodd"
						...
						<sec:authorize access="isAuthenticated()">
							...
							<a
								...
								title="스크랩북" aria-label="스크랩북" href="/users/4672761/collections">
...
<path fill="none" stroke="currentColor" stroke-linecap="round"
										...
										d="M10.04 4.19C10.16 3.16 10.6 2 12.05 2c1.35 0 1.78 1.11 1.9 2.13C21.05 5.25 21 13.43 21 19H3c0-5.48-.05-13.48 7.04-14.81zM10 19c0 1.66.9 3 2 3s2-1.34 2-3"></path>
...
<a class="layout-navigation-bar-icon" title="장바구니" aria-label="장바구니"
								href="/cart"> <svg class="icon" width="24" height="24"
...
</svg> <!-- <span class="layout-navigation-bar-icon__ticker"></span> -->
...
<div class="drop-down layout-navigation-bar-user-section my">
								...
								<button class="layout-navigation-bar-user-button myBtn"
...
<sec:authentication property="principal" var="memberVO" />
							...
							<input type="hidden" name="id" id="memberVO_id"
								value="${memberVO.id}" />
...
-->
						...
						<a class="layout-navigation-secondary__menu__item"
							data-word="category" href="/store/category">카테고리</a> <a
							class="layout-navigation-secondary__menu__item"
							data-word="questions" href="/store/best">베스트</a> ​
...
var urlArr = pageUrl.split('localhost/store/');

var dataArr = $('.layout-navigation-secondary__menu a');

​

var questionArr = urlArr[1].split('?');

if(typeof questionArr[1] != 'undefined'){

$.each(dataArr, function(index, item){

if($(item).attr('data-word')==questionArr[0] || $(item).attr('data-word')+'/'==questionArr[0]){
...
<path fill="#FFF" fill-rule="nonzero"
	...
	<div>
		...
		<div
			class="popout popout--prepared popout--axis-1 popout--dir-2 popout--cross-dir-2 mymenu"
			data-popout="true"
			style="position: absolute; z-index: 1000; top: 70px; right: 501.5px; display: none;">
				...
				<ul class="layout-navigation-bar-user-menu">
					...
					<sec:authorize access="isAuthenticated()">
						...
						<li class="layout-navigation-bar-user-menu__item-wrap"><a
							...
							href="../member/mypage?memberNum=${num.memberNum}">마이페이지</a></li>
					...
					<li class="layout-navigation-bar-user-menu__item-wrap"><a
						class="layout-navigation-bar-user-menu__item" href="/cscenter">고객센터</a>

					</li>

					<li class="layout-navigation-bar-user-menu__item-wrap">

						<button class="layout-navigation-bar-user-menu__item logout"
	...
	<sec:authorize access="!isAuthenticated()">
		...
		<div>
			...
			<div
				class="popout popout--prepared popout--axis-1 popout--dir-2 popout--cross-dir-1 writemenu"
				data-popout="true"
				style="display: none; position: absolute; z-index: 1000; left: 1470px; top: 64px; transform: translateX(-50%);">
				...
				<div class="animated-popout drop-down__content open open-active">
					...
					<div class="_2TAbe navigation-upload-dropdown-content">
						...
						<a class="navigation-upload-dropdown-content-item"
							href="../member/memberLogin">

							<div class="navigation-upload-dropdown-content-item__icon">

								<svg fill="none" viewBox="0 0 36 36" width="36" height="36"
									preserveAspectRatio="xMidYMid meet">

<rect x="6.54" y="3.59" width="27" height="29" rx="2.5"
										transform="rotate(4 6.54 3.6)" fill="#DBDBDB" stroke="#000"
										stroke-linejoin="round"></rect>

<rect x="2.5" y="1.5" width="27" height="29" rx="2.5" fill="#fff"
										stroke="#000" stroke-linejoin="round"></rect>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M5 19l22 2v7L5 26v-7z"
										fill="#E6A87C"></path>

<path fill-rule="evenodd" clip-rule="evenodd" d="M5 3.45h5v16l-5 4v-20z"
										fill="#F1C8A3"></path>
								...
								<svg fill="none" viewBox="0 0 18 18" width="18" height="18"
									preserveAspectRatio="xMidYMid meet"
									class="css-13x8x0f-DropDownNewIcon e5mhexx0">

<path d="M0 9a9 9 0 1118 0A9 9 0 010 9z" fill="#fff"></path>

<path fill-rule="evenodd" clip-rule="evenodd"
										d="M9 18A9 9 0 109 0a9 9 0 000 18zm-1.7-5.25H5.26v-7.5h2.61l2.8 4.2h.03v-4.2h2.06v7.5h-2.3L7.36 8.07h-.05v4.68z"
										fill="#F77"></path>
							...
							<div class="navigation-upload-dropdown-content-item__content">
								...
								<div class="navigation-upload-dropdown-content-item__subtitle">동영상
									기능이 추가되었어요!</div>

							</div>

						</a> <a class="navigation-upload-dropdown-content-item"
							href="../member/memberLogin">
...
<path stroke="#000" stroke-linecap="round" stroke-linejoin="round"
										d="M4.8 29.31V14.38h22.4v14.93H4.8z"></path>

<path fill="#FFF"
										d="M16 19.05a4.67 4.67 0 014.67 4.66v5.6h-9.34v-5.6A4.67 4.67 0 0116 19.05z"></path>
...
<path fill="#FBDEC1"
										d="M2.94 14.38a.9.9 0 01-.81-1.3l3.25-6.6a.9.9 0 01.8-.5h19.64c.34 0 .65.2.8.5l3.25 6.6a.9.9 0 01-.8 1.3H2.93z"></path>

<path fill="#E9C39D"
										d="M2.94 14.38a.9.9 0 01-.81-1.3l.74-1.5h26.26l.74 1.5a.9.9 0 01-.8 1.3H2.92z"></path>

<path stroke="#000" stroke-linecap="round" stroke-linejoin="round"
										d="M2.94 14.38a.9.9 0 01-.81-1.3l3.25-6.6a.9.9 0 01.8-.5h19.64c.34 0 .65.2.8.5h0l3.25 6.6a.9.9 0 01-.8 1.3h0H2.93z"></path>
...
<rect width="6" height="2" x="-14" y="3" stroke="#000" rx="1"
										transform="rotate(-90)" ry="1"></rect>

<rect width="5" height="1" x="-13.5" y="3.5" fill="#ffdb92" rx=".5"
										transform="rotate(-90)" ry=".5"></rect>
...
<path fill="#000" d="M30 32l2-2h-4z"></path>
							...
							<div class="navigation-upload-dropdown-content-item__content">
								...
								<div class="navigation-upload-dropdown-content-item__title">집들이
									글쓰기</div>

								<div class="navigation-upload-dropdown-content-item__subtitle">집에
									관한 이야기를 글로 작성해보세요.</div>
...
<rect width="4" height="8" x="3" y="21" fill="#FFB787" stroke="#000"
										rx="2"></rect>
...
<rect width="6" height="3" x="9" y="5" fill="#DB9F77" stroke="#FFF"
										rx="1.5"></rect>

<rect width="6" height="3" x="9" y="17" fill="#DB9F77" stroke="#FFF"
										rx="1.5"></rect>
...
<path fill-rule="evenodd" clip-rule="evenodd"
						...
						</a> <a class="navigation-upload-dropdown-content-item" href="#">
