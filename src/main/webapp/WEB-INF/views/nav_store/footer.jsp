...
<a class="layout-navigation-primary__menu__item layout-navigation-primary__menu__item--active layout-navigation-primary__menu__item--open" href="/store/category">스토어</a>
...
<a class="layout-navigation-secondary__menu__item" data-word="category" href="/store/category">카테고리</a>

<a class="layout-navigation-secondary__menu__item" data-word="questions" href="/store/best">베스트</a>
...
var urlArr = pageUrl.split('localhost:8080/store/');
...
[출처] nav_store/footer.jsp|작성자 onlytoday93