...
<div class="commerce-cart-wrap">
        ...
        <div class="commerce-cart row">
            <div class="commerce-cart__content-wrap col-12 col-md-7 col-lg-8">
                <div class="commerce-cart__content">
                    <div data-sticky-enabled="false" data-sticky-disabled="true" data-sticky-always="false" data-sticky-ignore="true" data-direction="top" data-offset="81" class="sticky-container commerce-cart__header-wrap">
                        <div class="sticky-child commerce-cart__header" style="position: relative;">
                            <span class="commerce-cart__header__left">
                                <label class="_3xqzr _4VN_z">
                                    ...
                                    <span class="_1aN3J"><span class="commerce-cart__header__caption">모두선택</span></span>
                                </label>
                            </span>
                            <span class="commerce-cart__header__right"><button class="commerce-cart__header__delete" type="button">선택삭제</button></span>
                        </div>
                    </div>
                    ...
                    <!-- ----------------------------------------------------- -->
                                                    ...
                                                    <article class="carted-product">
                                                        ...
                                                        <a class="product-small-item product-small-item--clickable" href="/productions/538782/selling">
                                                            <div class="product-small-item__image">
                                                                <picture>
                                                                    <source
                                                                        src="https://image.ohou.se/i/bucketplace-v2-development/uploads/productions/160386868728370588.jpg?w=256&amp;h=256&amp;c=c&amp;webp=1"
                                                                        srcset="
                                                                            https://image.ohou.se/i/bucketplace-v2-development/uploads/productions/160386868728370588.jpg?w=360&amp;h=360&amp;c=c&amp;webp=1 1.5x,
                                                                            https://image.ohou.se/i/bucketplace-v2-development/uploads/productions/160386868728370588.jpg?w=480&amp;h=480&amp;c=c&amp;webp=1 2x,
                                                                            https://image.ohou.se/i/bucketplace-v2-development/uploads/productions/160386868728370588.jpg?w=720&amp;h=720&amp;c=c&amp;webp=1 3x
                                                                    ...
                                                                    <img
                                                                        ...
                                                                        srcset="
                                                                            ...
                                                                            https://image.ohou.se/i/bucketplace-v2-development/uploads/productions/160386868728370588.jpg?w=720&amp;h=720&amp;c=c 3x
                                                                        "
                                                                    />
                                                                </picture>
                                                            </div>
                                                            <div class="product-small-item__content">
                                                                <h1 class="product-small-item__title">[에어론] 리버서블 오피스 데스크 책상/테이블 600~2400mm(2colors)</h1>
                                                                <p class="css-f55hds-Caption e1xep4wb0">배송비 8,000원&nbsp;|&nbsp;일반택배</p>
                                                            </div>
                                                        </a>
                                                        <button class="carted-product__delete" type="button" aria-label="삭제">
                                                            <svg width="12" height="12" viewBox="0 0 12 12" fill="currentColor" preserveAspectRatio="xMidYMid meet">
                                                        ...
                                                        <div class="carted-product__footer">
                                                            <span class="carted-product__footer__left">
                                                                <button class="carted-product__edit-btn" type="button">옵션변경</button><button class="carted-product__order-btn" type="button">바로구매</button>
                                                            </span>
                                                            <span class="carted-product__subtotal"><span class="carted-product__subtotal__number">101,900</span>원</span>
                                                        </div>
                                                    </article>
                                                </li>
                                            </ul>
                                            <footer class="commerce-cart__delivery-group__footer"><p class="commerce-cart__delivery-group__total">배송비 8,000원</p></footer>
                                        </article>
                                    </li>
                                </ul>
                            </article>
                        ...
                        <li class="commerce-cart__content__group-item">
                            <article class="commerce-cart__group">
                                <h1 class="commerce-cart__group__header">리샘가구 배송</h1>
                                <ul class="commerce-cart__group__item-list">
                                    <li class="commerce-cart__group__item">
                                        <article class="commerce-cart__delivery-group">
                                            <ul class="commerce-cart__delivery-group__product-list">
                                                <li class="commerce-cart__delivery-group__product-item">
                                                    <article class="carted-product">
                                                        ...
                                                        <a class="product-small-item product-small-item--clickable" href="/productions/310649/selling">
                                                            <div class="product-small-item__image">
                                                                <picture>
                                                                    <source
                                                                        src="https://image.ohou.se/i/bucketplace-v2-development/uploads/productions/162676121775574674.jpg?w=256&amp;h=256&amp;c=c&amp;webp=1"
                                                                        srcset="
                                                                            https://image.ohou.se/i/bucketplace-v2-development/uploads/productions/162676121775574674.jpg?w=360&amp;h=360&amp;c=c&amp;webp=1 1.5x,
                                                                            https://image.ohou.se/i/bucketplace-v2-development/uploads/productions/162676121775574674.jpg?w=480&amp;h=480&amp;c=c&amp;webp=1 2x,
                                                                            https://image.ohou.se/i/bucketplace-v2-development/uploads/productions/162676121775574674.jpg?w=720&amp;h=720&amp;c=c&amp;webp=1 3x
                                                                        "
                                                                        type="image/webp"
                                                                    />
                                                                    <img
                                                                        alt=""
                                                                        src="https://image.ohou.se/i/bucketplace-v2-development/uploads/productions/162676121775574674.jpg?w=256&amp;h=256&amp;c=c"
                                                                        srcset="
                                                                            https://image.ohou.se/i/bucketplace-v2-development/uploads/productions/162676121775574674.jpg?w=360&amp;h=360&amp;c=c 1.5x,
                                                                            https://image.ohou.se/i/bucketplace-v2-development/uploads/productions/162676121775574674.jpg?w=480&amp;h=480&amp;c=c 2x,
                                                                            https://image.ohou.se/i/bucketplace-v2-development/uploads/productions/162676121775574674.jpg?w=720&amp;h=720&amp;c=c 3x
                                                                        "
                                                                    />
                                                                </picture>
                                                            </div>
                                                            <div class="product-small-item__content">
                                                                <h1 class="product-small-item__title">[리샘] 캐더린 LED 통서랍 수납침대 SS/Q</h1>
                                                                <p class="css-f55hds-Caption e1xep4wb0">배송비 35,000원 착불&nbsp;|&nbsp;업체직접배송</p>
                                                            </div>
                                                        </a>
                                                        <button class="carted-product__delete" type="button" aria-label="삭제">
                                                            <svg width="12" height="12" viewBox="0 0 12 12" fill="currentColor" preserveAspectRatio="xMidYMid meet">
                                                        ...
                                                        <ul class="carted-product__option-list">
                                                            <li class="carted-product__option-list__item">
                                                                <article class="selling-option-item">
                                                                    <h2 class="selling-option-item__name">상품선택: 슈퍼싱글SS 프레임만 / 색상선택: 화이트</h2>
                                                                    ...
                                                                    <div class="selling-option-item__controls">
                                                                        ...
                                                                        <p class="selling-option-item__price"><span class="selling-option-item__price__number">149,000</span>원</p>
                                                                    </div>
                                                                </article>
                                                            </li>
                                                            <li class="carted-product__option-list__item">
                                                                <article class="selling-option-item">
                                                                    <h2 class="selling-option-item__name">추가상품 - 퀸Q 인디파워독립매트</h2>
                                                                    <button class="selling-option-item__delete" type="button" aria-label="삭제">
                                                                        <svg width="12" height="12" viewBox="0 0 12 12" fill="currentColor" preserveAspectRatio="xMidYMid meet">
                                                                            <path fill-rule="nonzero" d="M6 4.6L10.3.3l1.4 1.4L7.4 6l4.3 4.3-1.4 1.4L6 7.4l-4.3 4.3-1.4-1.4L4.6 6 .3 1.7 1.7.3 6 4.6z"></path>
                                                                        </svg>
                                                                    ...
                                                                    <div class="selling-option-item__controls">
                                                                        ...
                                                                        <p class="selling-option-item__price"><span class="selling-option-item__price__number">129,000</span>원</p>
                                                                    </div>
                                                                </article>
                                                            </li>
                                                        </ul>
                                                        <div class="carted-product__footer">
                                                            ...
                                                            <span class="carted-product__subtotal"><span class="carted-product__subtotal__number">278,000</span>원</span>
                                                        </div>
                                                    </article>
                                                </li>
                                            </ul>
                                            <footer class="commerce-cart__delivery-group__footer"><p class="commerce-cart__delivery-group__total">배송비 착불 35,000원</p></footer>
                                        </article>
                                    </li>
                                </ul>
                            </article>
                    ...
                    <dl class="commerce-cart__summary commerce-cart__content__summary">
                        <div class="commerce-cart__summary__row">
                            <dt>총 상품금액</dt>
                            <dd><span class="number">971,000</span>원</dd>
                        </div>
                        <div class="commerce-cart__summary__row">
                            <dt>총 배송비</dt>
                            <dd>+ <span class="number">8,000</span>원</dd>
                        </div>
                        <div class="commerce-cart__summary__row">
                            <dt>총 할인금액</dt>
                            <dd>- <span class="number">591,100</span>원</dd>
                        </div>
                        <div class="commerce-cart__summary__row commerce-cart__summary__row--total">
                            <dt>결제금액</dt>
                            <dd><span class="number">387,900</span>원</dd>
                        </div>
                    </dl>
                </div>
            </div>
            <div class="commerce-cart__side-bar-wrap col-12 col-md-5 col-lg-4">
                ...
                >
                    <div class="sticky-child commerce-cart__side-bar" style="position: relative;">
                        ...
                        <div class="commerce-cart__side-bar__order"><button class="_1eWD8 _3SroY _27do9 commerce-cart__side-bar__order__btn" type="button">2개 상품 구매하기</button></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    >
        <div class="sticky-child commerce-cart__footer" style="position: relative;">
            <div class="commerce-cart__footer__total"><span class="count">2개 </span><span class="cost">387,900원</span></div>
            <button class="_1eWD8 _3SroY _16Bs1 commerce-cart__footer__order" type="button">바로구매</button>
        </div>
    </div>
</div>
