...
<body>
	...
	<section class="css-9pkojs-SignUpWrapper e1y3odo25 section">
	<a href="/">
	...
	<svg width="48" height="48" viewBox="0 0 48 48" preserveAspectRatio="xMidYMid meet"><g fill="none" fill-rule="evenodd">
	<path fill="#3B5998" d="M0 24C0 10.745 10.745 0 24 0s24 10.745 24 24-10.745 24-24 24S0 37.255 0 24z"></path><path fill="#FFF" d="M25.77 35V24h3.384v-3.385h-3.385v-2.538c-.012-.756.08-1.285 1.693-1.692h1.692V13h-3.385c-3.25 0-4.52 1.84-4.23 5.077v2.538H19V24h2.538v11h4.231z"></path></g></svg></a></li><li class="css-1balhvh-SNSItem e111gxds0"><a href="/users/auth/kakao"><svg width="48" height="48" viewBox="0 0 48 48" preserveAspectRatio="xMidYMid meet">
	<g fill="none" fill-rule="evenodd"><path fill="#FFEB00" d="M0 24C0 10.745 10.745 0 24 0s24 10.745 24 24-10.745 24-24 24S0 37.255 0 24z"></path>
	...
	<li class="css-1balhvh-SNSItem e111gxds0"><a href="/users/auth/naver"><svg width="48" height="48" viewBox="0 0 48 48" preserveAspectRatio="xMidYMid meet"><g fill="none" fill-rule="evenodd"><path fill="#00C63B" d="M0 24C0 10.745 10.745 0 24 0s24 10.745 24 24-10.745 24-24 24S0 37.255 0 24z"></path>
	...
	<input class="form-control" value="" placeholder="이메일" size="1"></span>
	...
	<input class="_3ASDR _1qwAY" value="" field="[object Object]" name="nickname" placeholder="별명 (2~15자)"></div>
	<div class="css-g2rihj-FieldWrapperContainer euhjq6q3">
	...
	<span class="_1aN3J">
	<div class="css-sgje51-TermText-TermsBoldText e1hy3kq3">전체동의</div></span></label></div>
	<label class="_3xqzr _4VN_z"><div class="_3zqA8">
	<input type="checkbox" class="_3UImz" name="agree1" value="">
	...
	<span class="_1aN3J">
	<div class="css-6shc5k-TermText e1hy3kq4">만 14세 이상입니다.
	<span class="css-jek1hu-Require e1hy3kq2">(필수)</span></div></span></label>
	<label class="_3xqzr _4VN_z">
	<div class="_3zqA8">
	<input type="checkbox" class="_3UImz" name="agree2" value=""><span class="_2mDYR">
	<svg width="1em" height="1em" viewBox="0 0 16 16" class="_2UftR">
	<path fill="currentColor" d="M6.185 10.247l7.079-7.297 1.435 1.393-8.443 8.703L1.3 8.432l1.363-1.464z"></path></svg></span></div>
	<span class="_1aN3J"><div class="css-6shc5k-TermText e1hy3kq4">
	<a target="_blank" class="css-1l9bn-UnderlinkLink e1hy3kq0" href="/usepolicy">이용약관</a>
	<span class="css-jek1hu-Require e1hy3kq2">(필수)</span></div></span></label>
	<label class="_3xqzr _4VN_z"><div class="_3zqA8">
	<input type="checkbox" class="_3UImz" name="agree3" value="">
	<span class="_2mDYR"><svg width="1em" height="1em" viewBox="0 0 16 16" class="_2UftR">
	<path fill="currentColor" d="M6.185 10.247l7.079-7.297 1.435 1.393-8.443 8.703L1.3 8.432l1.363-1.464z"></path></svg></span></div>
	<span class="_1aN3J">
	<div class="css-6shc5k-TermText e1hy3kq4">
	<a target="_blank" class="css-1l9bn-UnderlinkLink e1hy3kq0" href="/privacy?type=register">개인정보수집 및 이용동의</a>
	<span class="css-jek1hu-Require e1hy3kq2">(필수)</span></div></span></label>
	<label class="_3xqzr _4VN_z">
	<div class="_3zqA8">
	<input type="checkbox" class="_3UImz" name="agreePromotion" value="">
	<span class="_2mDYR"><svg width="1em" height="1em" viewBox="0 0 16 16" class="_2UftR">
	<path fill="currentColor" d="M6.185 10.247l7.079-7.297 1.435 1.393-8.443 8.703L1.3 8.432l1.363-1.464z"></path></svg></span></div>
	<span class="_1aN3J">
	<div class="css-6shc5k-TermText e1hy3kq4">이벤트, 프로모션 알림 메일 및 SMS 수신
	<span class="css-1m03qc5-Option e1hy3kq1">(선택)</span></div></span></label></div></div>
	<button class="_3Z6oR _3AsCW _2tsrJ css-1c1st7f-ButtonWrapper e1y3odo22" type="submit">회원가입하기</button>
	</form>
