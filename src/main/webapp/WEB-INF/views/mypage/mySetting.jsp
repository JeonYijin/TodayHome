		...
		<div class="edit-user-info">
			...
			<div class="edit-user-info__wrap container">
				<div class="edit-user-info__header">
					...
					<div class="withdraw"><a class="edit-user-info__header__withdrawals" href="#">탈퇴하기</a></div>
					<input type="hidden" value="${member.memberNum}" id="memNum">
				</div>
				<form>
					<div class="edit-user-info__form-item">
						<div class="edit-user-info__form-item__title">이메일<div class="edit-user-info__form-item__title__require"> * 필수항목</div></div>
									...
									<div class="edit-user-info__form-item__field">
										<div class="input-group email-input">
											<span class="email-input__local">
												...
												<input class="form-control" readonly="readonly" placeholder="이메일" size="1" id="emailId" value="">
											</span>
											 <span class="email-input__separator">@</span>
											<span class="email-input__domain">
											<input class="form-control" readonly="readonly" placeholder="이메일" size="1" id="emailAddr" value="">
												<!-- <select class="form-control">
													<option value="" disabled="">선택해주세요</option>
													<option value="naver.com" disabled="disabled">naver.com</option>
													...
													<option value="outlook.com" disabled="disabled">outlook.com</option>
													<option value="icloud.com" disabled="disabled">icloud.com</option>
													<option value="_manual" disabled="disabled">직접입력</option>
												</select> -->
											</span>
										</div>
					...
					<div class="edit-user-info__form-item">
						<div class="edit-user-info__form-item__title">별명<div class="edit-user-info__form-item__title__require"> * 필수항목</div></div>
						<div class="expert-form-group edit-user-info__form-item__group">
							<div class="expert-form-group__content">
								<div class="expert-form-group__input">
									<div class="edit-user-info__form-item__field">
										<div class="edit-user-info__input">
											<input class="form-control" name="nickname" id="nick" value="${member.nickname}">
								...
								<div class="expert-form-group__input">
									<div class="edit-user-info__form-item__field">
										<div class="DayPickerInput">
											<input placeholder="YYYY-MM-DD" class="form-control date-input__text" value="">
										</div>
									</div>
								</div>
							</div>
				...
				<button class="button button--color-blue button--size-50 button--shape-4 edit-user-info__submit updateBtn" type="button">회원 정보 수정</button>
...
$('.withdraw').click(function(){
	let wd = confirm("정말로 탈퇴하시겠습니까?");
	let memberNum = $('#memNum').val();
	if(wd){
		location.href="../member/memberDelete?memberNum="+memberNum;
	}
})
//아이디 이메일 분할하기
let memberID= $('#memberId').val()
let id = memberID.split('@')[0];
let idaddr = memberID.split('@')[1];
console.log(memberID);
console.log(idaddr);
$('#emailId').attr('value', id);
$('#emailAddr').attr('value', idaddr);
