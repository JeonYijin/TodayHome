			...
			<div class="css-1hrluq4-Container ekbdbra0" >
				<div class="css-1xn9eio-Row el2z1iq0">
					...
					<!--  -->
						<!-- 좋아요 게시글 영역 -->
						<div class="css-1c8k8vc-Col e15wafbq0">
							<div class="css-1vav2tc-Div e1lm7yo61">
								<div class="virtualized-list row" style="padding-top: 0px; padding-bottom: 0px; transform: translateY(0px);">
								<c:forEach items="${heartPic}" var="heart">
									<div class="col-6 col-lg-4" style="">
										<div class="css-11syldp-FeedItem e1lm7yo60">
											<a class="css-11kfzam-PraiseItemLink e1vfbmcc3" href="../picture/picOne?post_id=${heart.post_id }">
											<c:forEach items="${heart.pictureFileVO}" var="file" varStatus="status">
												<c:if test="${status.index ==0}">
												<img class="css-m9by0t-PraiseItemImage e1vfbmcc2" src="../resources/upload/picture/${file.picFilename}">
												</c:if>
												<span class="css-q81wq8-PraiseItemType e1vfbmcc1">사진</span>
											</c:forEach>
											</a>
										</div>
									</div>
