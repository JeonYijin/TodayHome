			...
			<div class="myhome-nav myhome-nav--owner">
				...
				<nav class="page-navigation myhome-nav__contents">
					<ul style="transform: translateX(0px);">
						...
						<li class="page-navigation__item"><a class="active" href="./myQna?memberNum=${member.memberNum}" target="_self">질문과답변</a></li>
						 ...
						 <div class="css-pme9oh-Div em2z9000">
							 <div class="css-slcgdl-HeaderContainer e1063pje4">
								 <div class="css-xflkqd-HeaderLeft e1063pje3">
									 <a class="css-1tbq2mt-HeaderLink e1063pje2" href="./myQna?memberNum=${member.memberNum}">나의 질문</a>
