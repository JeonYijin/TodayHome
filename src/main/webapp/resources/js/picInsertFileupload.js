...
$('.files').on('click', '.fileupload', function(){
	...
	$('.files').append(imagediv);
		...
		let imgv= '<div class="upload" style="width: 360px; height: 300px;" id="imageContainer0">';
		 $(".files").append(imgv);
	let i = 0;
...
function makeList(){
	...
	//list = list + '<input type="file" name="files" class= "file" data-num="'+idNum+'" accept="image/**" style="display:none;" onchange="setThumbnail(this, event);">';
